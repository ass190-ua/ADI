  ...
  <div class="page" data-component="MainLayout">
    ...
    <main class="container auth-page" data-component="AuthMain">
      <Transition name="fade-slide">
        <section
          class="card pad"
          style="width:min(380px,92%); margin-inline:auto;"
          data-component="AuthCard"
        >
          <h1 class="h2" style="margin:0 0 6px; text-align:center;" data-part="title">
            Iniciar sesión
          </h1>
          ...
          >
            <div class="input" data-part="field">
              ...
              <input
                ...
                type="text"
                placeholder="correo@dominio.com / tuUsuario"
            ...
            <!-- 👇 Mensaje de error con transición fade -->
            <Transition name="fade">
              <p
                v-if="errorMsg"
                class="p"
                style="margin-top:8px; text-align:center; color: var(--error);"
              >
                {{ errorMsg }}
              </p>
            </Transition>
            ...
            <div class="p" style="margin-top:6px; text-align:center;" data-part="signup-hint">
              ¿No tienes cuenta?
              <RouterLink to="/register" class="link" data-part="signup-link">
...
function triggerShake() {
  // Reinicia la animación cada vez que hay error
  shake.value = false;
  // Esperamos al siguiente frame para volver a activarla
...
async function onSubmit() {
  ...
  try {
    ...
    triggerShake(); // Aquí disparamos el temblor
  } finally {
